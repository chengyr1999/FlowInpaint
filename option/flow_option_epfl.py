...
#                     help='image dataset directory')
parser.add_argument('--file_name', type=str, default='epfl',
                    help='image dataset directory')
...
parser.add_argument('--port', type=int, default=12054,
...
parser.add_argument('--save_dir', type=str, default='../FlowInterp_result/epfl_flow_store_model',
                    help='directory for saving models and logs')
parser.add_argument('--img_save_dir', type=str, default='../FlowInterp_result/epfl_Interp_result',
                    help='directory for saving models and logs')
