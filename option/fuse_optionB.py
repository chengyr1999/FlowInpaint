...
parser.add_argument('--pre_train', type=str, default='./FlowFuse_result_cremi/B_fuse_store_model/FlowFuse_CREMI_B_256/gen_00108.pth',
...
parser.add_argument('--port', type=int, default=23524,
...
parser.add_argument('--img_save_freq', type=int, default= 20,
                    help='')
parser.add_argument('--valid_output_dir', type=str, default='./B_fuse_valid_result',
                    help='directory for saving models and logs')
