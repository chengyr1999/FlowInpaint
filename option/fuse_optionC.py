...
parser.add_argument('--pre_train', type=str, default='./FlowFuse_result_cremi/C_fuse_store_model/FlowFuse_CREMI_C_256/gen_00107.pth',
...
#                     help='path to pretrained models')
parser.add_argument('--Interp_pre_train', type=str, default='../FlowInterp_result/C_flow_store_model_our/FlowInterp_CREMI_C_256/flow_00053.pth',
                    help='path to pretrained models')
...
parser.add_argument('--img_save_freq', type=int, default= 20,
                    help='')
parser.add_argument('--valid_output_dir', type=str, default='./C_fuse_valid_result',
                    help='directory for saving models and logs')
