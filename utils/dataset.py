...
class Dataset(torch.utils.data.Dataset):
    ...
    def load_item(self, index):
        ...
        img1_name = 'img'+img_path.split('_em')[1].split('/')[0]+'_1.png'
        img2_name = 'img'+img_path.split('_em')[1].split('/')[0]+'_2.png'
        img3_name = 'img'+img_path.split('_em')[1].split('/')[0]+'_3.png'
        img_inter_name = 'img'+img_path.split('_em')[1].split('/')[0]+'inter_2.png'
        # print('img_path is',img_path)
        # print('img1_name is',img1_name)
        # sys.exit()
        #image_read
        ...
        mask_size = 0.5*self.img_size * self.img_size
        h_ = random.randint(int(0.65*self.img_size), int(0.75*self.img_size))
        w_ = int(mask_size//h_)
